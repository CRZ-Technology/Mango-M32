...
static int8_t CUSTOM_HID_OutEvent_FS(uint8_t event_idx, uint8_t state)
{
  /* USER CODE BEGIN 6 */
	  ...
	  {
	  case 1: /* LED1 */
	    (state == 1) ?   HAL_GPIO_WritePin(GPIOF, LED1_Pin, GPIO_PIN_RESET): HAL_GPIO_WritePin(GPIOF, LED1_Pin, GPIO_PIN_SET);
	    break;

	  case 2: /* LED2 */
	    (state == 1) ?   HAL_GPIO_WritePin(GPIOF, LED2_Pin, GPIO_PIN_RESET): HAL_GPIO_WritePin(GPIOF, LED2_Pin, GPIO_PIN_SET);
	    break;
	  case 3: /* LED3 */
	    (state == 1) ?   HAL_GPIO_WritePin(GPIOF, LED3_Pin, GPIO_PIN_RESET): HAL_GPIO_WritePin(GPIOF, LED3_Pin, GPIO_PIN_SET);
	    break;
